  ...
  return (
    <Card className="w-[350px]">
      <CardHeader>
        ...
        <CardDescription>Εισάγετε τα στοιχεία σας για να αποκτήσετε πρόσβαση στον λογαριασμό σας.</CardDescription>
      </CardHeader>
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter className="flex flex-col gap-2">
          <Button type="submit" className="w-full">Σύνδεση / Εγγραφή</Button>
